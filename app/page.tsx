...
export default function Home() {
  return (
    <div className="flex max-w-8xl w-full h-full justify-between">
      <div className="basis-2/3 w-full">
        <div className="flex w-full justify-between px-1 my-10">
          <h1 className="font-vazirmatn text-3xl text-white font-black">
            محمد مهدی
          </h1>
          <h1 className="text-white text-3xl font-black">Mohammad Mahdi</h1>
        </div>
        <p className="text-right text-white font-vazirmatn text-xl my-10 leading-loose">
          برنامه‌نویس فرانت‌اند با بیش از 1 سال تجربه در توسعه و طراحی
