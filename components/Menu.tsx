...
const Menu = () => {
  ...
  return (
    <div className="lg:w-5/6 w-full max-w-8xl flex items-center justify-between text-sm backdrop-blur-md bg-white/30 py-4 rounded-xl px-5">
      ...
      <div className="block lg:hidden z-10">
        ...
        />
        {openMenu && (
          <div className="absolute text-black z-50 h-screen w-screen flex-col gap-2 -top-10 right-0 px-5 flex filter backdrop-blur-xl bg-white/90">
            <IoClose className="h-10 w-10 drop-shadow-lg my-2  mr-auto" onClick={()=>setOpenMenu(false)} size={'2em'} />
            <Link
